...
export const metadata: Metadata = {
  ...
  keywords: "dog walking Chiswick, pet sitting London, dog walker Chiswick, pet care London, professional dog walking, pet sitting services, dog walking Chiswick London, pet care Chiswick, dog sitting, pet sitting near me",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-1711585612"></script>
        <script
